...
class DataService {
  ...
  initializeDefaultData(): void {
    ...
    },
    {
      ...
      description: "Celular Samsung con cámara de 50MP y batería de larga duración.",
      price: 1299.0,
      stock: 30,
      category: "Telefonía",
      sku: "SMART-SAMS-001",
    ...
    },
    {
      ...
      description: "Mouse para juegos con iluminación RGB y sensor preciso.",
      price: 120.0,
      stock: 70,
      category: "Gaming",
      sku: "MOUSE-LOGI-001",
    ...
    },
    {
      ...
      description: "Teclado mecánico compacto ideal para FPS con switches Cherry MX.",
      price: 350.0,
      stock: 20,
      category: "Gaming",
      sku: "TECL-HYPX-001",
    ...
    },
    {
      ...
      description: "Almacenamiento portátil de 1TB, compatible con USB 3.0.",
      price: 220.0,
      stock: 40,
    ...
    },
    {
      ...
      description: "Cámara web Full HD 1080p para videollamadas y streaming.",
      price: 180.0,
      stock: 25,
      category: "Periféricos",
      sku: "WEBC-LOGI-001",
    ...
    },
    {
      ...
      description: "Tableta para dibujo digital, ideal para artistas y diseñadores.",
      price: 450.0,
      stock: 12,
      category: "Diseño",
    ...
    {
      id: "prod-014",
      name: "Auriculares Gaming HyperX Cloud Stinger Core",
      description: "Auriculares con micrófono para gamers, ligeros y cómodos.",
      price: 190.0,
      stock: 28,
      category: "Gaming",
      sku: "AUR-HYPX-001",
    ...
    },
    {
      ...
      description: "Consola híbrida con pantalla OLED, ideal para jugar en casa o fuera.",
      price: 1899.0,
      stock: 7,
      category: "Gaming",
      sku: "CONSOL-NINT-001",
    ...
    },
    {
      ...
      description: "Tarjeta de video de alto rendimiento para gaming y diseño.",
      price: 2500.0,
      stock: 5,
    ...
    },
    {
      ...
      description: "Proyector compacto con Android TV integrado y resolución Full HD.",
      price: 3200.0,
      stock: 4,
    ...
    },
    {
      ...
      description: "Cámara DSLR con sensor de 24.2MP y conectividad Wi-Fi/NFC.",
      price: 1750.0,
      stock: 6,
      category: "Fotografía",
      sku: "CAM-CANN-001",
    ...
    },
    {
      ...
      description: "Reloj inteligente para corredores con GPS y monitoreo de pulso.",
      price: 950.0,
      stock: 18,
      category: "Wearables",
      sku: "SW-GARM-001",
    ...
    {
      id: "prod-022",
      name: "Base Enfriadora para Laptop Cooler Master",
      description: "Base con ventiladores para evitar el sobrecalentamiento de tu laptop.",
      price: 95.0,
      stock: 60,
      category: "Accesorios",
      sku: "BASE-COOL-001",
    ...
    },
    {
      ...
      description: "Micrófono de condensador ideal para podcasting y streaming.",
      price: 400.0,
      stock: 22,
      category: "Audio",
      sku: "MIC-BLUE-001",
    ...
    },
    {
      ...
      description: "Aspiradora robótica con vaciado automático y navegación inteligente.",
      price: 2100.0,
      stock: 9,
