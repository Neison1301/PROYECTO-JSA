...
                      </span>
                      {producto.stock < 10 && (
                        <AlertTriangle size={16} className="text-warning ms-1" /> // Ícono de advertencia
                      )}
                    </div>
                  </td>
                  <td>
...
                  </td>
                  <td>
                    <small>{formatearFecha(producto.createdAt)}</small> {/* Mostrar fecha formateada */}
                  </td>
                  <td>
                    <div className="btn-group">
                      <button
                        className="btn btn-sm btn-outline-primary"
                        onClick={() => manejarEdicion(producto)} // Botón para editar
                        title="Editar"
                      >
                        <Edit size={14} />
                      </button>
...
                        onClick={() => manejarEliminacion(producto)} // Botón para eliminar
                        title="Eliminar"
                      >
                        <Trash2 size={14} />
                      </button>
